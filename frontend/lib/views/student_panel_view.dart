...
class _StudentPanelViewState extends State<StudentPanelView> {
  ...
  void initState() {
    ...
    _projects = [
      const _StudentProject(
        ...
        classGroup: 'ADS 2024.1',
        date: '14/03/2024',
        status: _StudentStatus.approved,
        coorientador: 'Prof. Heuryk Wylk',
        description:
            'Plataforma IoT para controle automatizado de dispositivos residenciais via app mobile.',
      ...
      const _StudentProject(
        id: 2,
        title: 'App de Gestão Acadêmica',
        classGroup: 'ADS 2024.1',
        date: '01/04/2024',
        status: _StudentStatus.pending,
        coorientador: 'Prof. Guibson Santana',
        description:
            'Aplicativo para gerenciamento de notas, frequências e comúnicação entre alunos e professores.',
        technologies: ['Flutter', 'Firebase', 'Dart'],
        githubLink: 'https://github.com/usuario/gestão-acadêmica',
      ),
      const _StudentProject(
        id: 3,
        title: 'Plataforma E-commerce Sustentavel',
        classGroup: 'ADS 2023.2',
        date: '19/11/2023',
        status: _StudentStatus.rejected,
        description:
            'Marketplace focado em produtos sustentaveis com rastreabilidade de cadeia de produção.',
        technologies: ['Vue.js', 'Laravel', 'MySQL'],
        githubLink: 'https://github.com/usuario/ecommerce-sustentavel',
        rejectionReason:
            'A documentacao técnica esta incompleta e o sistema não atende aos requisitos mínimos de seguranca. Solicita-se revisão e nova submissão.',
      ),
    ];
  }
  ...
  // CREATE
  void _submitForm() {
    if (_nameCtrl.text.trim().isEmpty || _selectedTurma == null) {
      return;
    }
  ...
  int get _pending =>
      _projects.where((p) => p.status == _StudentStatus.pending).length;
  int get _approved =>
      _projects.where((p) => p.status == _StudentStatus.approved).length;
  int get _rejected =>
      _projects.where((p) => p.status == _StudentStatus.rejected).length;

  List<String> get _allTechnologies =>
      _projects.expand((p) => p.technologies).toSet().toList();
                            ...
                            children: [
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        const Text(
                                          'Submeta novos PIs e acompanhe o status de aprovação',
                                          style: TextStyle(
                                            fontSize: 13,
                                  ...
                                  if (!_showForm) ...[
                                    if (!mobile) ...[
                                      ...
                                      OutlinedButton.icon(
                                        onPressed: () => _MatchingDialog.show(
                                          context,
                                          technologies: _allTechnologies,
                                        ),
                                        icon: const Icon(
                                          Icons.hub_outlined,
                                          size: 18,
                              ...
                              if (_showForm) ...[
                                _NewProjectForm(
                                  ...
                                  repoCtrl: _repoCtrl,
                                  demoCtrl: _demoCtrl,
                                  selectedTurma: _selectedTurma,
                                  techTags: _techTags,
                                  mobile: mobile,
                                  onTurmaChanged: (v) =>
                                      setState(() => _selectedTurma = v),
                                  onAddTag: _addTag,
                                  onRemoveTag: (t) =>
                                      setState(() => _techTags.remove(t)),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 4),
                                    const Text(
                                      'Todos os seus projetos submetidos a plataforma',
                                      style: TextStyle(
                                        fontSize: 12,
            ...
            (e) => Expanded(
              child: Padding(
                padding: EdgeInsets.only(
                  right: e.key < cards.length - 1 ? 16.0 : 0.0,
                ),
                child: e.value,
              ),
            ),
    ...
    return Table(
      ...
      children: [
        TableRow(
          ...
          children: ['PROJETO', 'TURMA', 'SUBMISSAO', 'STATUS', 'ACOES']
              .asMap()
              .entries
              .map(
                (e) => Padding(
                  ...
                  child: Text(
                    e.value,
                    textAlign: e.key == 4 ? TextAlign.right : TextAlign.left,
                    style: const TextStyle(
                      fontSize: 11,
                      fontWeight: FontWeight.w600,
                      color: AppColors.textMuted,
                ...
                child: Wrap(
                  ...
                  children: [
                    ActionBtn(
                      ...
                      onPressed: () =>
                          _ProjectDetailsDialog.show(context, project: p),
                    ),
                    ActionBtn(
                      label: 'Editar',
                      ...
                      onPressed: () => _EditProjectDialog.show(
                        context,
                        project: p,
                        onUpdate: onUpdate,
                      ),
...
class _NewProjectForm extends StatelessWidget {
                ...
                const Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Preencha os dados do seu Projeto Integrador',
                        style: TextStyle(
                          fontSize: 12,
                          color: AppColors.textSecondary,
                        ),
              ...
              children: [
                ...
                mobile
                    ? Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          _lbl('Nome do Projeto *'),
                          _txt(nameCtrl, 'Ex: Sistema de Gestão de Estoque'),
                          const SizedBox(height: 16),
                          _lbl('Turma *'),
                          _drop(selectedTurma, onTurmaChanged),
                        ],
                      )
                    : Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                _txt(
                                  nameCtrl,
                                  'Ex: Sistema de Gestão de Estoque',
                                ),
                              ],
                            ),
                          ),
                ...
                const SizedBox(height: 20),
                _lbl('Coorientador'),
                _txt(coCtrl, 'Nome do professor coorientador (opcional)'),
                const SizedBox(height: 20),
                _lbl('Descrição Completa *'),
                _txt(
                  descCtrl,
                  'Descreva o objetivo, metodologia e resultados esperados...',
                  maxLines: 5,
                ),
                const SizedBox(height: 20),
                // Tags
  ...
  Widget _txt(TextEditingController c, String h, {int maxLines = 1}) =>
      TextField(
        controller: c,
        maxLines: maxLines,
        style: const TextStyle(fontSize: 13),
  ...
  Widget _drop(String? v, ValueChanged<String?> onChange) =>
      _StyledDropdown(value: v, onChanged: onChange, items: _kTurmas);
  Widget _link(
    IconData icon,
    String label,
...
class _EditProjectDialog extends StatefulWidget {
  ...
  static Future<void> show(
    ...
    required void Function(_StudentProject) onUpdate,
  }) => showDialog(
    context: ctx,
...
class _EditProjectDialogState extends State<_EditProjectDialog> {
  ...
  void _save() {
    if (_titleCtrl.text.trim().isEmpty || _turma == null) {
      return;
    }
    widget.onUpdate(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(
                      '${widget.project.classGroup} — ${widget.project.date}',
                      style: const TextStyle(
                        fontSize: 12,
                        color: AppColors.textMuted,
                      ),
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              _lbl('Título *'),
                              _txt(_titleCtrl, 'Título do projeto'),
                            ],
                          ),
                        ),
                        const SizedBox(width: 16),
                    ...
                    const SizedBox(height: 16),
                    _lbl('Coorientador'),
                    _txt(_coCtrl, 'Nome do professor coorientador'),
                    const SizedBox(height: 16),
                    _lbl('Descrição'),
                    _txt(_descCtrl, 'Descreva o projeto...', maxLines: 4),
                    const SizedBox(height: 16),
                    // Tags
                    Row(
                      children: [
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              _lbl('Link Repositório'),
                              _txt(_repoCtrl, 'https://github.com/...'),
                            ],
                          ),
                        ),
                        const SizedBox(width: 16),
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              _lbl('Link Demo Live'),
                              _txt(_demoCtrl, 'https://meu-projeto.vercel.app'),
                            ],
                          ),
                        ),
                      ],
                    ),
                    if (widget.project.status == _StudentStatus.rejected &&
                        widget.project.rejectionReason != null) ...[
                      const SizedBox(height: 16),
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                'Motivo da reprovação: ${widget.project.rejectionReason}',
                                style: const TextStyle(
                                  fontSize: 12,
                                  color: AppColors.statusRejectedFg,
                                  height: 1.4,
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 4),
                              Text(
                                '${p.classGroup} · Submetido em ${p.date}',
                                style: const TextStyle(
                                  fontSize: 12,
                                  color: AppColors.textMuted,
                                ),
                    ...
                    if (p.githubLink.isNotEmpty || p.demoLink.isNotEmpty) ...[
                      const SizedBox(height: 16),
                      Row(
                        children: [
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            const Text(
              'Tem certeza que deseja excluir este projeto? Esta acao não pode ser desfeita.',
...
class _MatchingDialog extends StatefulWidget {
  final List<String> technologies;
  const _MatchingDialog({required this.technologies});
  ...
  static Future<void> show(
    ...
    context: ctx,
    barrierColor: Colors.black.withValues(alpha: 0.5),
    builder: (_) => _MatchingDialog(technologies: technologies),
  );
...
class _MatchingDialogState extends State<_MatchingDialog> {
  ...
  Future<void> _load() async {
    final m = await AppServices.matching.findMatches(widget.technologies);
    if (mounted) {
      setState(() {
        _matches = m;
        _loading = false;
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Empresas compativeis com seu perfil',
            ...
            Flexible(
              child: _loading
                  ...
                  ? const Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 12),
                          Text(
                            'Nenhuma empresa encontrada para suas tecnologias.',
                            style: TextStyle(color: AppColors.textMuted),
                            textAlign: TextAlign.center,
                          ),
                        ],
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (_, i) => _MatchCard(match: _matches![i]),
                    ),
            ),
...
class _QrCodeDialog extends StatelessWidget {
  ...
  static Future<void> show(BuildContext ctx) => showDialog(
    context: ctx,
    barrierColor: Colors.black.withValues(alpha: 0.5),
    builder: (_) => const _QrCodeDialog(),
  );

  @override
  Widget build(BuildContext context) {
    const portfolioUrl = 'https://jeeploo.github.io/SENAC-DEVNEST/';
    final qrUrl =
        'https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=${Uri.encodeComponent(portfolioUrl)}&bgcolor=ffffff&color=00838F&qzone=2';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 4),
              const Text(
                'para acessar seu portfolio público',

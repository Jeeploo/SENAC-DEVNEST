                      ...
                      child: ConstrainedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text(
                              'Acompanhe as estatisticas e metricas do SENAC DevNest',
                              style: TextStyle(
                                fontSize: 13,
              ...
              .map(
                (e) => Padding(
                  padding: EdgeInsets.only(
                    right: e.key < _kStats.length - 1 ? 12 : 0,
                  ),
      ...
      children: _kStats
          .map(
            (s) => Expanded(
              child: Padding(
                padding: EdgeInsets.only(
                  right: _kStats.indexOf(s) < _kStats.length - 1 ? 16 : 0,
                ),
                child: _StatCard(s: s),
              ),
            ),
  ...
  Widget build(BuildContext context) => SizedBox(
    ...
    child: LayoutBuilder(
      builder: (ctx, box) => MouseRegion(
        ...
        onHover: (e) =>
            setState(() => _hovered = _hitTest(e.localPosition, box.maxWidth)),
  ...
  Widget build(BuildContext context) => SizedBox(
    ...
    child: LayoutBuilder(
      builder: (ctx, box) => MouseRegion(
        cursor: _hovered != null ? SystemMouseCursors.click : MouseCursor.defer,
        onHover: (e) => setState(
          () => _hovered = _hitTest(e.localPosition, Size(box.maxWidth, _h)),
        ),
        onExit: (_) => setState(() => _hovered = null),
        child: CustomPaint(
          size: Size(box.maxWidth, _h),
